    ...
    def onSearch(self):
        ...
        if not product.empty:
            ...
            for i in range(int(quantity)):
                # 获取新的批次号
                new_batch_number = get_new_batch_number(nonSplitDate, description)
                new_batch_number += i
                with open('初始.pdf', 'rb') as f:
                    ...
                    for j in range(labels_per_box):
                        label_filename = f'pdfs/output_{product_name}_{timestamp}_{i}_{j}.pdf'
